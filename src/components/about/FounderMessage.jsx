...
useGSAP(
  ...
  return (
    <section ref={sectionRef} className="relative bg-[#f5f0e7] overflow-hidden py-16 sm:py-16 md:py-18 lg:py-16 xl:py-20">
  ...
  />
      ...
      <div className="mx-auto max-w-7xl px-6 lg:px-16">
        ...
        <div className="grid grid-cols-1 md:grid-cols-1 lg:grid-cols-2 gap-10 sm:gap-10 md:gap-12 lg:gap-16 xl:gap-16 items-start">
          ...
          <div>
            {/* Eyebrow */}
            <div data-eyebrow className="flex items-center gap-3 mb-4 sm:mb-4 md:mb-5 lg:mb-5 xl:mb-5">
            ...
            <h2  data-headline className={`${cormorant.className} leading-[1.0] text-[#241A12]`}>
              <span data-segment className="block text-[36px] sm:text-[36px] md:text-[46px] lg:text-[54px] xl:text-[60px] font-semibold">
                Our Commitment,
              </span>
              <span data-segment className="block text-[36px] sm:text-[36px] md:text-[46px] lg:text-[54px] xl:text-[60px] italic font-medium text-[#6E7E45]">
                To You.
              </span>
            </h2>

            {/* Gold underline + leaf */}
            <div  data-divider-group className="flex items-center gap-3 mt-4 mb-5 sm:mb-5 md:mb-6 lg:mb-7 xl:mb-7">
              <div className="h-px w-16 bg-[#C49A2A]/50" />
               <div data-divider-leaf
            ...
            <div data-signature className="mt-7 sm:mt-7 md:mt-8 lg:mt-8 xl:mt-8">
              <p
