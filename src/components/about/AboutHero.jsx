      ...
      <div className="relative z-10 mx-auto w-full max-w-7xl px-6 lg:px-16 py-20">
        <div className="max-w-[520px]">
          ...
          <div className="flex items-center gap-2 mb-8">
            ...
            <span className={`${montserrat.className} text-[11px] uppercase tracking-[0.15em] text-[#5f5146]/60`}
          ...
          {/* Headline */}
          <h1 className={`${cormorant.className} text-[72px] lg:text-[96px] font-semibold text-[#241A12] leading-[0.95]`}>
            About Us
          </h1>
          ...
          <p className={`${montserrat.className} text-[14px] lg:text-[15px] text-[#5f5146] leading-[1.8]`}
            style={{ fontWeight: 400 }}>
            Delivering farm-fresh eggs with care,<br />
