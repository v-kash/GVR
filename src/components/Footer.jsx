      ...
      <div className="mx-auto max-w-7xl px-6 lg:px-16 pt-16 pb-8">
        <div className="grid grid-cols-1 md: grid-cols-2 lg:grid-cols-[2fr_1fr_1fr_1.5fr] gap-12 lg:gap-8">
          ...
          <div>
            ...
            {/* Tagline */}
            <p className={`${cormorant.className} text-[20px] italic text-[#c5db8e] leading-snug mb-4`}
              style={{ fontWeight: 400 }}>
              From our farm,<br />to your table.
            </p>

            <p className={`${montserrat.className} text-[12px] text-[#f5f0e7]/50 leading-[1.8] max-w-[260px]`}
              style={{ fontWeight: 400 }}>
              Premium farm fresh eggs and dry fish delivered daily with hygiene, care and trusted quality.
            </p>
          ...
          {/* ── COL 2: Quick Links ── */}
          <div>
            <p className={`${montserrat.className} text-[10px] uppercase tracking-[0.2em] text-[#6E7E45] mb-5`}
              ...
              {navLinks.map((link, i) => (
                <li key={i}>
                  <a
                    ...
                    style={{ fontWeight: 400 }}
                  >
                    <ArrowRight size={11} className="opacity-0 group-hover:opacity-100 transition-opacity duration-200 text-[#6E7E45]" />
                    {link.label}
                  </a>
                </li>
              ))}
          ...
          <div>
            ...
            <div className="flex flex-col gap-4">
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  <p className={`${montserrat.className} text-[10px] uppercase tracking-[0.1em] text-[#f5f0e7]/40 mb-0.5`}
                    style={{ fontWeight: 500 }}>
                    Call Us
                  </p>
                  <a href="tel:+919448453609"
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <a href="mailto:info@gvrfreshfoods.com"
                    className={`${montserrat.className} text-[13px] text-[#f5f0e7]/80 hover:text-[#c5db8e] transition-colors`}
                    style={{ fontWeight: 500 }}>
                    info@gvrfreshfoods.com
                  </a>
                </div>
              </div>
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className={`${montserrat.className} text-[13px] text-[#f5f0e7]/80 leading-[1.6]`}
                    style={{ fontWeight: 400 }}>
                    Karnataka, India
                  </p>
                </div>
        ...
        <div className="mt-7 flex flex-col lg:flex-row items-center justify-between gap-4">
          ...
          {/* Copyright */}
          <p className={`${montserrat.className} text-[11px] text-[#f5f0e7]/30`}
            style={{ fontWeight: 400 }}>
